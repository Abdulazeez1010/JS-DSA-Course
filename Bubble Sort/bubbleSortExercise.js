...
//  Implement a function called bubbleSort. Given an
// array, bubbleSort will sort the values in the array.
...
//   }
// }
// The comparator function is a callback that will take
// two values from the array to be compared. The
// function returns a negative value if the first value
// is less than the second, a positive value if the
// first value is greater than the second, and 0 if
// oth values are equal.

// The default comparator you provide should assume
// that the two parameters are numbers and that we
// are sorting the values from smallest to largest.

// Bubble sort is an O(n^2) algorithm. You can read
// more about it here:
